			...
			<BackgroundBeamsWithCollision>
				...
				<div className='relative w-full z-10 flex flex-col items-center justify-center space-y-4 sm:space-y-8 text-center'>
					...
					<h1 className='text-4xl sm:text-6xl md:text-8xl font-bold text-foreground flex flex-col items-center gap-1 sm:gap-2'>
						<AnimatedGradientText>AHMED</AnimatedGradientText>
						<span className='text-3xl sm:text-5xl md:text-7xl'>IBRAHEEM</span>
					</h1>

					<p className='text-lg sm:text-xl md:text-2xl font-light tracking-wide max-w-3xl mx-auto text-muted-foreground uppercase'>
						MERN STACK
					...
					<p className='text-sm sm:text-base md:text-lg font-light tracking-wide max-w-2xl mx-auto text-muted-foreground/80 leading-relaxed'>
						A passionate Full-Stack Web Developer specializing in the MERN stack and Django for backend development, with hands-on experience in building dynamic and scalable web applications.
					</p>
