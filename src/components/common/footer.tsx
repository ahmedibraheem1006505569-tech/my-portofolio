	...
	return (
		<footer className='overflow-hidden pt-8 pb-16 border-t border-neutral-200 dark:border-neutral-800 dark:bg-neutral-950'>
			<div className='container mx-auto px-4 sm:px-6 lg:px-8  flex flex-col justify-between gap-12 md:flex-row'>
				<div className='flex-1'>
					...
					<p className='mt-4 max-w-xs text-sm leading-relaxed text-neutral-600 dark:text-neutral-400'>
						Fullstack developer crafting beautiful and functional web
						experiences.
					</p>
					<p className='mt-6 text-xs text-neutral-500 dark:text-neutral-500'>
						© {new Date().getFullYear()} Ahmed Ibraheem Ahmed. All rights reserved.
					</p>
				</div>
			...
			<div className='relative flex items-center justify-center'>
				<h1 className='pointer-events-none select-none mb-0 text-center text-5xl font-black tracking-tight text-transparent sm:mb-6 md:text-6xl lg:text-[7rem] bg-linear-to-b from-neutral-600 via-neutral-400 to-neutral-200 bg-clip-text dark:from-neutral-400 dark:via-neutral-600 dark:to-neutral-900'>
					AHMED
				</h1>
			</div>
		</footer>
